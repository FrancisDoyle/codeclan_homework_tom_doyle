...
movies_runtime <- movies_selected %>% 
  select(runtime) %>%   #not sure about this
...
I think i made  a mistake with selected because my movies_imputed has only the runtime things i think it was the select() i used previously but scared ot break everything